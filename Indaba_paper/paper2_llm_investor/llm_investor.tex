...
\title{Startup Investment Readiness Classification and Local Advisory for Tech Founders}
...
Generic commercial AI tools partially address the mentorship
...
Figure~\ref{fig:cm_xgb} shows the per-class prediction breakdown for the
deployed XGBoost classifier. It correctly classifies 9{,}586/9{,}604
\texttt{mentorship\_needed} instances and 117/861
\texttt{investment\_ready} instances, yielding the most balanced diagonal
among all eight models. Classical alternatives achieve substantially lower
\texttt{investment\_ready} recall (Random Forest 162/861, Logistic
Regression 114/861, SVC 107/861), while all three 1D-CNN variants
near-totally collapse the minority class (best: CNN\_C 103/861), confirming
XGBoost as the production model for this severely imbalanced tabular task.

\begin{figure}[H]
\centering
\onesinglecm{XGBoost (Deployed)}{36}{528}{25}{5}{9586}{13}{9}{735}{117}
\caption{XGBoost confusion matrix on the 11{,}054-record held-out set.
         Achieves 9{,}586/9{,}604 \texttt{mentorship\_needed} and
         117/861 \texttt{investment\_ready} correctly classified.
