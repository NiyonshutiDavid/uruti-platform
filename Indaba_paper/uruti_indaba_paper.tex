...
reported figures.
Figures~\ref{fig:cm_cnn_a}--\ref{fig:cm_cnn_c} compare CNN confusion matrices
and confirm that all three CNN variants collapse minority-class predictions into
