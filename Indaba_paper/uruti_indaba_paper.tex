...
\begin{axis}[
    xbar, bar width=9pt,
    width=0.92\columnwidth, height=7.0cm,
    xlabel={Weighted F1 (\%)}, xlabel style={font=\small},
    symbolic y coords={
      CNN\_A,
      ExtraTrees,
      CNN\_B,
    ...
    grid=major, grid style={dotted, gray!40},
    tick label style={font=\scriptsize},
    title={Investor Readiness Engine — Model F1 Comparison},
    title style={font=\small\bfseries},
]
\addplot[
    fill=blue!55, fill opacity=0.85,
    postaction={pattern=none},
] coordinates {
    (80.95, CNN\_A)
    (81.77, ExtraTrees)
    (83.07, CNN\_B)
...
\end{axis}
\end{tikzpicture}
\caption{Weighted F1 comparison of all 8 models on the held-out test set
         (11{,}054 records). XGBoost (83.82\%) leads marginally but all models
         cluster tightly between 81--84\%, revealing that the dominant challenge
         is minority-class recall rather than overall accuracy.}
