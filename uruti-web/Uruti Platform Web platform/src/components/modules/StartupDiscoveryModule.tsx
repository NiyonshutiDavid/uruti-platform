              ...
              <div className="space-y-3">
                ...
                <div className="flex gap-2 pt-2">
                  ...
                  <Button
                    ...
                    className={`${
                      venture.bookmarked 
                        ? 'bg-[#76B947]/10 border-[#76B947] text-[#76B947] hover:bg-[#76B947]/20' 
                        : 'hover:bg-[#76B947]/10 hover:border-[#76B947]'
                    } transition-all`}
                    title={venture.bookmarked ? 'Remove from Deal Flow' : 'Add to Deal Flow'}
                  >
                    <Bookmark className={`h-4 w-4 ${venture.bookmarked ? 'fill-[#76B947]' : ''}`} />
                  </Button>
                </div>
